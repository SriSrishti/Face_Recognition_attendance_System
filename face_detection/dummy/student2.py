            ...
            try:
                ...
                while True:
                    ...
                    if cropped_face is not None:
                        ...
                        # Save the face with the student's name
                        student_name = self.var_std_name.get().replace(" ", "_")  # Replace spaces with underscores
                        file_path = f"data/{student_name}_{str(img_id)}.jpg"
